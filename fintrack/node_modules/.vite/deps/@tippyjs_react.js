...
var forwardRef = function(Tippy, defaultProps2) {
  return (0, import_react.forwardRef)(function TippyWrapper(_ref, _ref2) {
    ...
    return (
      ...
      // some reason
      import_react.default.createElement(Tippy, Object.assign({}, defaultProps2, props), children ? (0, import_react.cloneElement)(children, {
        ref: function ref(node) {
...
export {
  tippy_react_esm_default as default,
