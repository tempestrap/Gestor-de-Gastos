  ...
  return (
    <div className="page center">
      <div className="auth-card" style={{ maxWidth: 600 }}>
        <h1 style={{ textAlign: 'center' }}>Onboarding — Paso {step} de 5</h1>
        <div style={{ marginTop: 20 }}>
              ...
              <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                {['Vivienda', 'Compras', 'Transporte', 'Salud', 'Entretenimiento', 'Comida'].map(c => (
                  <button
                    ...
                    className={data.frequentCategories.includes(c) ? 'btn' : 'card'}
                  >
                    {c}
                  </button>
                ))}
          ...
          {step === 4 && (
            <div>
              ...
              <ul>
                {data.goals.map((g, i) => (
                  <li key={i}>{g.title} — ${g.targetAmount} — {g.targetDate}</li>
                ))}
              </ul>
              <div style={{ marginTop: 12 }}>
